    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <nav className="bg-white shadow-md">
        <div className="container mx-auto flex justify-between items-center p-4">
          ...
          <Link
            to="/"
            className="text-2xl font-bold bg-gradient-to-r from-gray-400 to-gray-700 bg-clip-text text-transparent"
          >
            Saylani
          </Link>
          ...
          <div className="flex items-center space-x-4">
            {user ? (
              ...
              <>
                <Link
                  to="/login"
                  className="bg-black text-white px-4 py-2 rounded-md hover:bg-gray-700transition"
                >
                  Login
                </Link>
                <Link
      ...
      <div className="container mx-auto flex-grow p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[ 
            ...
            >
              <h2 className="text-xl font-bold mb-2 text-gray-700">{loan.title}</h2>
