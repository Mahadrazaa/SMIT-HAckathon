    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-6">
      {!isSubmitted ? (
        <div className="bg-white shadow-lg rounded-lg p-6 max-w-md w-full">
          <h1 className="text-2xl font-bold text-black mb-4 text-center">Loan Request</h1>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              {formData.loanDetails.loanCategory && (
                <select
                  ...
                  className="mt-2 w-full px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-black"
                >
            ...
            <button
              type="submit"
              className="w-full bg-gray-700 text-white font-medium py-2 rounded-lg hover:bg-black transition"
            >
              Submit
            </button>
          </form>
