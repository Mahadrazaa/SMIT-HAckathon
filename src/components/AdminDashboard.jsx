  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="bg-gray-100 text-gray-800 w-64 p-6 shadow">
        <h1 className="text-2xl font-bold mb-8 text-black">Admin Dashboard</h1>
        <nav>
      ...
      <main className="flex-1 p-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg">
            ...
            <p className="text-4xl font-bold text-black">567</p>
          </div>

          {/* Card 3: Revenue */}
          <div className="bg-white p-6 rounded-lg shadow hover:shadow-lg">
            <h2 className="text-lg font-semibold text-gray-600 mb-2">Revenue (PKR)</h2>
            <p className="text-4xl font-bold text-black">7,890,000</p>
          </div>
        </div>
